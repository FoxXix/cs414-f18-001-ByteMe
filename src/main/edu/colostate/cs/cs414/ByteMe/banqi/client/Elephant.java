...
public class Elephant implements Piece{
	...
	/*To be implemented.  This method determines whether the move intended for the Elephant
	...
	The boolean variable 'visible' associated with the Elephant is set to true.*/
	@Override
	public void makeVisible() {
		visible = true;
	}
	
	/*Returns the status of the Elephant Piece, giving whether it is still face-down or face-up.*/
	@Override
