...
public class Soldier implements Piece{
	...
	/*To be implemented.  This method determines whether the move intended for the Soldier
	...
	/*Returns the status of the Soldier Piece, giving whether it is still face-down or face-up.*/
	@Override
